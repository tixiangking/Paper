...
\begin{document}
	...
	\begin{figure}[htb] 
		\center{\includegraphics[width=0.95\textwidth]  {fig12.png}} 
	...
	\begin{figure}[htb] 
		\center{\includegraphics[width=0.25\textwidth]  {fig5.png}} 
	...
	\begin{figure}[htb] 
		\center{\includegraphics[width=0.95\textwidth]  {fig11.png}} 
	...
	\begin{figure}[htb] 
		\center{\includegraphics[width=0.95\textwidth]  {fig21.png}} 
	...
	\begin{figure}[htb]
		\center{\includegraphics[width=0.95\textwidth]  {fig29.png}}
	...
	\begin{figure}[htb]
		\center{\includegraphics[width=0.95\textwidth]  {fig30.png}}
	...
	\begin{figure}[htb]
		\center{\includegraphics[width=0.95\textwidth]  {fig17.png}}
	...
	\begin{figure}[H]
		\center{\includegraphics[width=0.95\textwidth]  {fig8.png}}
	...
	\begin{figure}[htb]
		\center{\includegraphics[width=0.5\textwidth]  {fig31.png}}
	...
	\begin{figure}[H]
		\center{\includegraphics[width=0.5\textwidth]  {fig32.png}}
	...
	\end{enumerate}
	\begin{figure}[H] 
		\center{\includegraphics[width=0.95\textwidth]  {fig33.png}} 
	...
	\begin{figure}[H] 
		\center{\includegraphics[width=0.95\textwidth]  {fig34.png}} 
	...
	\begin{figure}[H] 
		\center{\includegraphics[width=0.95\textwidth]  {fig35.png}} 
	...
	实验结果如图3.1所示。
	\begin{figure}[htb] 
		\center{\includegraphics[width=0.95\textwidth]  {fig40.png}} 
	...
	\begin{figure}[htb] 
		\center{\includegraphics[width=0.95\textwidth]  {fig38.png}} 
		\bicaption{图}{添加线性均衡器之前的误码率曲线}{Fig}{BER curve before adding linear equalizer}
	\end{figure}
	\begin{figure}[htb] 
		\center{\includegraphics[width=0.95\textwidth]  {fig39.png}} 
	...
	\begin{figure}[H] 
		\center{\includegraphics[width=0.95\textwidth]  {fig37.png}} 
	...
	\begin{figure}[htb] 
		\center{\includegraphics[width=0.95\textwidth]  {fig36.png}}
	...
	\begin{figure}[H] 
		\center{\includegraphics[width=0.5\textwidth]  {fig10.png}} 
	...
	\begin{figure}[htb] 
		\center{\includegraphics[width=0.95\textwidth]  {fig25.png}} 
	...
	\begin{figure}[htb] 
		\center{\includegraphics[width=0.95\textwidth]  {fig24.png}} 
		\bicaption{图}{时间戳补偿前后同步误差超出阈值概率与网络规模关系对比图}{Fig}{Comparison chart of the relationship between the synchronization error exceeding the threshold probability and the network scale before and after timestamp compensation}
	\end{figure}
	...
	\begin{figure}[H] 
		\center{\includegraphics[width=0.95\textwidth]  {fig23.png}} 
